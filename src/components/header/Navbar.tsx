  ...
  return (
    <nav className="w-[100%] h-[4rem] flex items-center px-6 max-lg:px-4 border-b">
        ...
        <div className="navlinks h-[100%] flex gap-9 max-md:gap-5 items-center max-md:hidden">
          ...
          <div className="rounded-3xl flex max-lg:hidden w-[40%] h-[60%] items-center border-2 p-2">
            <input
              ...
              placeholder="Search..."
              name=""
              className="rounded-3xl w-[90%] h-full outline-none px-2"
            />
            <CiSearch
              style={{
                color: "#000",
      ...
      <div className=" w-[50%] flex justify-end items-center gap-10 max-sm:gap-5 h-full font-semibold text-white ">
        <BsFillMoonStarsFill
          style={{ color: "#111827", width: 24, height: 24, cursor: "pointer" }}
        />
        <div className="flex gap-3 items-center justify-end w-[30%] max-lg:w-[50%] h-[70%] max-md:hidden">
          <Link
            href=""
            className="rounded-3xl bg-[#146EF5] hover:bg-[#0d5fd8] px-2 text-[1rem] h-full max-lg:w-[55%] w-[55%] flex justify-center duration-200 items-center text-center max-md:text-[0.9rem]"
          >
            Sign Up
          </Link>
          <Link
            href=""
            className="text-gray-900 rounded-3xl hover:bg-[#F3F4F6] border px-2 text-[1rem] h-full max-lg:w-[45%] w-[45%] flex justify-center items-center duration-200 text-center max-md:text-[0.9rem]"
          >
            Login
          </Link>
        </div>
        <Link
          href=""
          className="hidden rounded-3xl bg-[#146EF5] hover:bg-[#FACC15] px-[3px] text-[1rem] max-sm:w-[50%] max-lg:w-[30%] h-[70%] max-sm:h-[65%] max-md:flex justify-center duration-200 items-center text-center max-md:text-[0.9rem]"
        >
          Sign Up
        </Link>
      </div>
